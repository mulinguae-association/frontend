...
const Home = ({ imgAnimation }) => {
  ...
  const imgSrc =
    "https://res.cloudinary.com/dfnwjr7vo/image/upload/f_auto/q_auto:good/w_1200/v1726238642/amazon_people.webp";
  const imgSrc2 =
    "https://res.cloudinary.com/dfnwjr7vo/image/upload/f_auto,w_700/v1707246278/earth_fnjwsd.webp";
  const imagesizes = "100vw";
  const imagesizes2 =
    "(max-width:256px) 256px,(max-width:384px) 384px,(max-width:640px) 640px";
        ...
        <div className="hero_image_wrapper">
          <picture>
            <source
              ...
              srcSet={criticalImages[0]}
              sizes={imagesizes}
            />
            <source
              media="(max-width:480px)"
              srcSet={criticalImages[1]}
              sizes={imagesizes}
            />
            <source
              media="(max-width:640px)"
              srcSet={criticalImages[2]}
              sizes={imagesizes}
            />
            <source
              media="(max-width:750px)"
              srcSet={criticalImages[3]}
              sizes={imagesizes}
            />
            <source
              media="(max-width:828px)"
              srcSet={criticalImages[4]}
              sizes={imagesizes}
            />
            <source
              media="(max-width:1080px)"
              srcSet={criticalImages[5]}
              sizes={imagesizes}
            />
            <source
              media="(max-width:1200px)"
              srcSet={criticalImages[6]}
              sizes={imagesizes}
            />
            <img
              fetchpriority="high"
            ...
            <div className="hero_info">
              ...
              >
                <picture>
                  <source
                    media="(max-width:256px)"
                    srcSet="https://res.cloudinary.com/dfnwjr7vo/image/upload/f_auto,w_256/v1707246278/earth_fnjwsd.webp 256w"
                  />
                  <source
                    media="(max-width:384px)"
                    srcSet="https://res.cloudinary.com/dfnwjr7vo/image/upload/f_auto,w_384/v1707246278/earth_fnjwsd.webp 384w"
                  />
                  <source
                  ...
                  <img
                    fetchpriority="high"
                    src={
                      "https://res.cloudinary.com/dfnwjr7vo/image/upload/f_auto,w_640/v1707246278/earth_fnjwsd.webp"
                    }
