...
function ResetPassword() {
  ...
  const isBtnDisabled = !formState.password || !formState.confirmPassword || formState.passError || isBtnLoading['resetBtn'];
          ...
          {formState.resetSuccessful ? (
            ...
            <form onSubmit={handleSubmit}>
              <div className='group'>
                ...
                />
                {formState.passError && <p className='error-msg'>{formState.passError}</p>}
              </div>
              <div className='group password'>
                ...
                />
                <div
                  style={isArabicDir ? { left: '15px', right: "unset", top: "42px" } : { right: '15px', left: "unset", top: "42px" }}
                  id="password_eye"
              ...
              <button className={`${isBtnDisabled ? 'disabled' : ''}`} disabled={isBtnDisabled} type="submit">
