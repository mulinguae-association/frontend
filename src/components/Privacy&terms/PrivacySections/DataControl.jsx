...
const DataControl = () => {
  ...
  return (
    <section id="data-control">
      ...
      <ul>
        {t("dataControl.description", { returnObjects: true }).map(
          (point, index) => (
      ...
      <div className="more_details">
        ...
        <div className="choices">
          {t("dataControl.moreDetails.dataControlChoices", {
            returnObjects: true,
          }).map((point) => (
        ...
        <div className="communication">
          <div className="head">
            <h3>
              {t("dataControl.moreDetails.communicationPreferences.title")}
            </h3>
            <p>
              {" "}
              {t(
                "dataControl.moreDetails.communicationPreferences.description",
              )}
            </p>
          </div>
          {(() => {
            const arr = t(
              "dataControl.moreDetails.communicationPreferences.options",
              { returnObjects: true },
            );
