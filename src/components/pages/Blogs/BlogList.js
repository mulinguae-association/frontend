...
import { AutoSizer, CellMeasurer, List, WindowScroller } from 'react-virtualized';
...
const BlogList = ({ acceptedPosts }) => {
  ...
  const rowContent = useCallback(({ key, index, style, parent }) => {
  ...
  }, [acceptedPosts, padding, minHeight]);

  return (
    <div className="blogs_content" style={{ height: '100%', width: '100%', display: "flex" }}>
