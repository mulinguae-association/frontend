        ...
        <article className='section multilingulism_info' ref={componentRef}>
          ...
          <section>
            ...
            <div className='about'>
              ...
              <p>{t("about_importanceLang2")}
                <a className='link' href='https://www.un.org/en/about-us/universal-declaration-of-human-rights'>{t("link")}</a>
                {t("about_importanceLang3")}
                <a className='link' href='https://www.unesco.org/en/legal-affairs/recommendation-concerning-promotion-and-use-multilingualism-and-universal-access-cyberspace?hub=66535'>{t("link2")}</a>
                {t("about_importanceLang4")}
              </p>
              <p>
                {t("about_importanceLang5")}
                <a className='link' href='https://documents-dds-ny.un.org/doc/UNDOC/GEN/N19/426/26/PDF/N1942626.pdf?OpenElement'>{t("link3")}</a>
              </p>
              <p>
                {t("about_importanceLang6")}
                <a className='link' href='https://idil2022-2032.org/'>{t("link4")}</a>
          ...
          <section>
            ...
            <div className='about'>
              <p>{t("about_linguaFranca")}
                <a className='link' href="https://www.un.org/fr/department-global-communications">{t("link5")}</a>
                {t("about_linguaFranca2")}
                <a className='link' href="https://www.un.org/en/multilingualism-web-standards">{t("link6")}</a>
                <a className='link' href="https://www.un.org/en/our-work/official-languages">{t("link7")}</a>
              </p>
            </div>
          </section>
            ...
            <ol className='about'>
              {langFactsArr.map((fact, idx) => (
                <li className='about' key={idx}>
                  ...
                  <span>
                    <a className='link' href={fact?.link}>{t(fact?.link)}</a>
                  </span>
                </li>
              ))}
            </ol>
