    ...
    <main>
      <div className='container'>
        <section className='section multilingulism_info' ref={componentRef}>
          ...
          <p className='about'>{t("about_importanceLang2")}
            <span>
              <a className='link' href='https://www.un.org/en/about-us/universal-declaration-of-human-rights'>
                {t("link")}</a>
            </span>
          ...
          <div className='languages_landscape'>
