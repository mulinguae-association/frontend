      ...
      <div className="custom-shape-divider-bottom-1707328329">
        <svg className="waves" xmlns="http://www.w3.org/2000/svg" viewBox="0 24 150 28" preserveAspectRatio="none" shapeRendering="auto">
          ...
          <g className="parallax">
            <use href="#gentle-wave" x="48" y="0" fill="rgba(242, 245, 247,0.7)" />
            <use href="#gentle-wave" x="48" y="3" fill="rgba(242, 245, 247,0.5)" />
            <use href="#gentle-wave" x="48" y="5" fill="rgba(242, 245, 247,1)" />
